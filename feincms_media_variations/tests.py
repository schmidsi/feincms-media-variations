...
class ThumbnailTest(TestCase):
    def setUp(self):
        ...
        mediafile = MediaFile(file=File(open('feincms_media_variations/fixtures/elephant_test_image.jpeg')))
        mediafile.save()
    ...
    def test_processing(self):
        ...
        thumbnail = self.image.variations.get_by_options([
            ('image_pil_open', {}),
            ('image_pil_command', {'convert', 'RGB'}),
            ('image_pil_thumbnail', {'height' : 40, 'width' : '34'}),
            ('image_pil_save', {'quality' : 80}),
        ])
